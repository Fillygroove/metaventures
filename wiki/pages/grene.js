let pageData = {
	name: '<a href="index.html?p=greme" class="no_style">Grēne</a>',
	navbox: {		
	...
	introText: [
		'Grēne is the first planet in the <a href="index.html?p=hotsun">Hot Sun</a> system, before <a href="index.html?p=doug">Doug</a>. It is about a fifty-fifth of the size of the Hot Sun. Grēne can barely be seen from <a href="index.html?p=ert">Ert</a>, looking like a sun spot due to how close it is to the Hot Sun, but since it revolves around the Hot Sun rather quickly, it looks like a sun spot that moves extremely quickly. It can only be observed by special means, specifically in day with special equipment.',
		'Grēne\'s surface is mostly composed of silicon and an unknown material, with the side of the planet facing the Hot Sun consisting of molten silicon. The atmosphere contains evaporated silicon, along with another unknown material that causes a cycle similar to the water cycle on <a href="index.html?p=ert">Ert</a> and <a href="index.html?p=george">George</a>. Said atmosphere is being stripped off of the planet by the solar wind, being blasted off, leaving a trail that constantly leaves the planet, facing away from the Hot Sun. A year on Grēne lasts 20 hours. Days can not be measured due to the planet being tidally locked to the Hot Sun.',
		'The term for describing something related to Grēne is Grenian.'
	],
	categories: [{
		name: 'Characteristics',
		info: [
			'Grēne is a Chthonian planet that mainly consists of a silicon-based material, along with a multitude of undiscovered elements, although aluminum is confirmed due to probes being sent there and promptly being melted by how hot the planet is. Most attempts of uncovering more elements only makes us more sure that aluminum is present on Grēne. Grēne is tidally locked to the Hot Sun, meaning that one side of the planet always faces it. Due to solar winds hitting the atmosphere, the atmosphere is physically stripped from the planet, causing a trail that affects Doug, and maybe even <a href="index.html?p=pilf">Pilf</a>.',
