	...
	navbox: {
		...
		info: [{
			...
			info: [{
				...
				name: 'Satellites',
				info: ['<a href="index.html?p=wop">World of Pain</a>, Dough']
			}, {
				name: 'Name Origin',
				info: ['Unknown']
			}, {
