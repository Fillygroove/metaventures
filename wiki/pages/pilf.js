let pageData = { // First!
	...
	categories: [{
		...
		info: [
			...
			'<a href="index.html?p=pilfception"><img src="images/pilf_atmosphere.png" alt="pilf_atmosphere.png" width="100" height="100" style="float: right; background-color: rgba(0, 0, 0, 0);"></img></a>',
			...
			'Pilf shares its cuboid shape with <a href="index.html?p=doug">Doug</a>\'s only satellite, H.'
		]
	}, {
		name: 'Satellites',
		info: [
			'<img src="images/piffol_rings.png" alt="piffol_rings.png" width="100" height="100" style="float: right; background-color: rgba(0, 0, 0, 0);"></img>',
			'<h3>Piffol Rings</h3>',
			'Pilf\'s only satellites are the Piffol Rings, a collection of ring like objects that surround the planet at a 30 degree angle. Pilf is one of the only two planets with a ring system, the other one being <a href="index.html?p=aeiou">Aeiou</a>. Each Piffol Ring is made up of a bunch of tightly packed globuals of liquids, that seem to have the same consistancy of custard. Each ring has a different shade of color, ranging from a light orange to a deep purple, all of which are usually very saturated. There are seven confirmed rings, each one named after flavors of cheese. The reason why the ring system is named the Piffol Rings is that Piffol is a corruption of the word Piffle, which means nonsense.'
		]
	}, {
		name: 'Life',
		info: [
